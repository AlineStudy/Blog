    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse navbar-collapse-example">
            ...
            <ul class="nav navbar-nav">
                <li class="active"><a href="your/nice/url">我的</a></li>
            ...
            <ul class="nav navbar-nav">
                <li><a href="${ctx}/writedream?id=${user.id}">写</a></li>
            </ul>
        ...
        <div class="foot-nav clearfix" style="position: absolute;left: 0px;margin-top: 20px;margin-left: 400px;text-align: center">
            <div class="foot-copyrights" style="margin-left: 100px">
                ...
                <p>
                    ...
                    <span style="color: white">>邮箱：121212@qq.com </span>
                </p>
                <p style="margin-top: 8px;color: white;font-size: 12px">&copy;www.xxxxxxx.wang  My Blog版权所有</p>
            </div>
        </div>
    </div>
</div>
