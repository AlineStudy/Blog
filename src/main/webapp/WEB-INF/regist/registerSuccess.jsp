...
<head>
    ...
    <script type="text/javascript" src="../../js/include/register.js"></script>
...
<div class="active-head">
    <div style="line-height: 44px;margin-left: 5px">
        <span style="color: white;font-family: Arial;font-size: 18px">My Blog注册成功页面</span>
    </div>
    <div class="content">
